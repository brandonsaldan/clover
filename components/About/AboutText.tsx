...
const AboutText = () => {
    return (
        <div className="text-black dark:text-white px-6 sm:px-0">
            ...
            <Text p className="mt-1">Right now, I'm learning <a className="underline decoration-[#388ed2] text-black dark:text-white relative before:content-[''] before:absolute before:block before:w-full before:h-[1.5px] before:bottom-0 before:left-0 before:bg-black dark:before:bg-white before:hover:scale-x-100 before:scale-x-0 before:origin-top-left before:transition before:ease-in-out before:duration-300" href="https://www.typescriptlang.org/">TypeScript</a> and <a className="underline decoration-[#2d2d2d] dark:decoration-[#70e1fc] text-black dark:text-white relative before:content-[''] before:absolute before:block before:w-full before:h-[1.5px] before:bottom-0 before:left-0 before:bg-black dark:before:bg-white before:hover:scale-x-100 before:scale-x-0 before:origin-top-left before:transition before:ease-in-out before:duration-300" href="https://reactjs.org/">React</a>, but I have experience working with everything below.</Text>
        </div>
    );
}
